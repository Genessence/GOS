                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className={`text-[10px] font-bold uppercase tracking-wider ${
                      item.type === 'PR' ? 'text-purple-500' : item.type === 'Timesheet' ? 'text-amber-500' : item.type === 'Leave' ? 'text-rose-500' : 'text-indigo-500'
                    }`}>
                      {item.type} Review
                    </span>
                ...
                {item.status === 'pending' ? (
                  <>
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-4 py-2 border rounded-xl text-xs font-semibold transition-colors ${
                        isDark ? 'border-slate-800 hover:bg-slate-800/40 text-slate-300' : 'border-slate-200 hover:bg-slate-50 text-slate-600'
                      }`}
                    >
