        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          <div className={`p-6 rounded-2xl border relative overflow-hidden flex flex-col items-center text-center ${
            ...
            {isOnBreak ? (
              ...
              <div className={`text-[10px] font-bold uppercase tracking-wider flex items-center space-x-1 mb-4 px-2.5 py-1 rounded-full ${
                isDark ? 'text-slate-400 bg-slate-800/40' : 'text-slate-500 bg-slate-100'
              }`}>
          ...
          <div className={`p-6 rounded-2xl border ${
            ...
            <h3 className={`text-xs font-bold ${isDark ? 'text-white border-slate-800/60' : 'text-slate-800 border-slate-200'} uppercase tracking-wider border-b pb-2 flex items-center space-x-2`}>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className={`p-6 rounded-2xl border flex flex-col h-full ${
            ...
            <div className={`flex items-center justify-between border-b pb-4 mb-4 ${isDark ? 'border-slate-800/60' : 'border-slate-200'}`}>
              <div>
                <h3 className={`text-xs font-bold ${isDark ? 'text-white' : 'text-slate-800'} uppercase tracking-wider`}>Daily Work Logs</h3>
              ...
              {entries.map((entry) => (
                ...
                >
                  <div className="space-y-1.5 flex-1">
                    ...
                    <h4 className={`text-xs font-semibold ${isDark ? 'text-white' : 'text-slate-850'}`}>{entry.task}</h4>
                  ...
                  <div className="flex items-center justify-between md:justify-end md:flex-col gap-2">
                    <span className={`text-xs font-bold px-3 py-1.5 rounded-xl border whitespace-nowrap ${
                      isDark 
                        ? 'text-white bg-slate-800/80 border-slate-700/30' 
            ...
            <div className={`flex justify-center border-t pt-4 mt-auto ${isDark ? 'border-slate-800/60' : 'border-slate-200'}`}>
